...
def run(p_seed=0, p_epochs=150, p_kernel_size=5, p_logdir="temp"):
    ...
    # data loader -----------------------------------------------------------------#
    train_dataset = ImageFolder(root='/Users/Gasto/Desktop/Omega_Training/Omega/data/merged_set/merged_set', transform=transform)
    test_dataset = ImageFolder(root='/Users/Gasto/Desktop/Omega_Training/Omega/data/merged_set/merged_set', transform=test_transform)
...
if __name__ == "__main__":
    ...
    p.add_argument("--trials", default=88, type=int)
